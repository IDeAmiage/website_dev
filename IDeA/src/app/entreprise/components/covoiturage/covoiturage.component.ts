...
export class CovoiturageComponent implements OnInit {
  ...
  /**
   * Method to load the trajects based on different filter and user geolocation
   *
   * @memberof CovoiturageComponent
   */
  loadTrajects() {
    ...
    obj.subscribe(res => {
      ...
      this.TrajetListe.forEach((element: any) => { // calculation of userdistance
  ...
  /**
   * On click open the post covoiturage component
   *
   * @memberof CovoiturageComponent
   */
  onCreate() {
  ...
  /**
   * Method to reorder the trajects by time to put the nearest by time first
   *
   * @memberof CovoiturageComponent
   */
  refreshByTime() {
  ...
  /**
   * Method to get the trajects of the current user
   *
   * @memberof CovoiturageComponent
   */
  getMyTrajects() {
  ...
  /**
   * Method to delete the traject selected
   *
   * @param {number} i
   * @memberof CovoiturageComponent
   */
  ...
  /**
   * Ajout d'un passager
   * Cette méthode verifie la place restante dans le vehicule et mets à jour le trajet
   * Quand un nouvel passager s'ajoute une notification windows est envoyée
   *
   * @param {number} i
   * @memberof CovoiturageComponent
   */
  ...
  /**
   * Method to suscribe the user to cloud messaging notification, if allowed the user will receive the notification
   *
   * @memberof CovoiturageComponent
   */
  requestPermission() {
